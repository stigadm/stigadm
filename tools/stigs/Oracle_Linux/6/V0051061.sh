...
# STIG_ID: V0051061
# STIG_Version: SV-65267r2
# Rule_ID: OL6-00-000165
#
# OS: Oracle_Linux
# Version: 6
# Architecture: 
...
# Description: The audit system must be configured to audit all attempts to alter system time through adjtimex.
