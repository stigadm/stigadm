...
# STIG_ID: V0047965
# STIG_Version: SOL-11.1-090110
# Rule_ID: The~operating~system~must~employ~automated~mechanisms~to~determine~the~state~of~system~components~with~regard~to~flaw~remediation~using~the~following~frequency
#
# OS: Solaris
# Version: 11
# Architecture: X86
#
# Title:  continuously, where HBSS is used; 30 days, for any additional internal network scans not covered by HBSS; and annually, for external scans by Computer Network Defense Service Provider (CNDSP).
