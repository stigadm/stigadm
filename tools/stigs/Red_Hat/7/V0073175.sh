...
# STIG_ID: V0073175
# STIG_Version: SV-87827r2
# Rule_ID: RHEL-07-040641
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The system must ignore Internet Protocol version 4 (IPv4) Internet Control Message Protocol (ICMP) redirect messages.
