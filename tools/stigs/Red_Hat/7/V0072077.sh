...
# STIG_ID: V0072077
# STIG_Version: SV-86701r2
# Rule_ID: RHEL-07-021710
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The Red Hat Enterprise Linux operating system must not have the telnet-server package installed.
