...
# STIG_ID: V0072025
# STIG_Version: SV-86649r1
# Rule_ID: RHEL-07-020670
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: All files and directories contained in local interactive user home directories must be group-owned by a group of which the home directory owner is a member.
