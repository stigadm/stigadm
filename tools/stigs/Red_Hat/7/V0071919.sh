...
# STIG_ID: V0071919
# STIG_Version: SV-86543r1
# Rule_ID: RHEL-07-010200
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The PAM system service must be configured to store only encrypted representations of passwords.
