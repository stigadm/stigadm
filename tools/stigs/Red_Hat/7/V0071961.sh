...
# STIG_ID: V0071961
# STIG_Version: SV-86585r2
# Rule_ID: RHEL-07-010480
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: Systems with a Basic Input/Output System (BIOS) must require authentication upon booting into single-user and maintenance modes.
