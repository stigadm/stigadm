...
# STIG_ID: V0072029
# STIG_Version: SV-86653r1
# Rule_ID: RHEL-07-020690
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: All local initialization files for interactive users must be owned by the home directory user or root.
