...
# STIG_ID: V0072211
# STIG_Version: SV-86835r2
# Rule_ID: RHEL-07-031010
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The Red Hat Enterprise Linux operating system must be configured so that the rsyslog daemon does not accept log messages from other servers unless the server is being used for log aggregation.
