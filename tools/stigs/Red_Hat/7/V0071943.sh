...
# STIG_ID: V0071943
# STIG_Version: SV-86567r4
# Rule_ID: RHEL-07-010320
#
# OS: Red_Hat
# Version: 7
# Architecture: 
#
# Title: Accounts on the Red Hat Enterprise Linux operating system that are subject to three unsuccessful logon attempts within 15 minutes must be locked for the maximum configurable period.
# Description: Accounts on the Red Hat Enterprise Linux operating system that are subject to three unsuccessful logon attempts within 15 minutes must be locked for the maximum configurable period.
