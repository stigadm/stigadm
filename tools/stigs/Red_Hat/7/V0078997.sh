...
# STIG_ID: V0078997
# STIG_Version: SV-93703r2
# Rule_ID: RHEL-07-010101
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The Red Hat Enterprise Linux operating system must prevent a user from overriding the screensaver idle-activation-enabled setting for the graphical user interface.
