...
# STIG_ID: V0072119
# STIG_Version: SV-86743r4
# Rule_ID: RHEL-07-030480
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The Red Hat Enterprise Linux operating system must audit all uses of the fremovexattr syscall.
