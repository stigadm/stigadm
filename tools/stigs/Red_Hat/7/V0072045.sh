...
# STIG_ID: V0072045
# STIG_Version: SV-86669r1
# Rule_ID: RHEL-07-021020
#
# OS: Red_Hat
# Version: 7
# Architecture: 
#
# Title: File systems that are being imported via Network File System (NFS) must be mounted to prevent files with the setuid and setgid bit set from being executed.
# Description: File systems that are being imported via Network File System (NFS) must be mounted to prevent files with the setuid and setgid bit set from being executed.
