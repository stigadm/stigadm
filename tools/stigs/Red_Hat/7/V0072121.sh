...
# STIG_ID: V0072121
# STIG_Version: SV-86745r4
# Rule_ID: RHEL-07-030490
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The Red Hat Enterprise Linux operating system must audit all uses of the lremovexattr syscall.
