...
# STIG_ID: V0072145
# STIG_Version: SV-86769r4
# Rule_ID: RHEL-07-030610
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The Red Hat Enterprise Linux operating system must generate audit records for all unsuccessful account access events.
