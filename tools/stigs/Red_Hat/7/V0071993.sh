...
# STIG_ID: V0071993
# STIG_Version: SV-86617r2
# Rule_ID: RHEL-07-020230
#
# OS: Red_Hat
# Version: 7
# Architecture: 
#
# Title: The Red Hat Enterprise Linux operating system must be configured so that the x86 Ctrl-Alt-Delete key sequence is disabled.
