...
# STIG_ID: V0072041
# STIG_Version: SV-86665r2
# Rule_ID: RHEL-07-021000
#
# OS: Red_Hat
# Version: 7
# Architecture: 
#
# Title: File systems that contain user home directories must be mounted to prevent files with the setuid and setgid bit set from being executed.
# Description: File systems that contain user home directories must be mounted to prevent files with the setuid and setgid bit set from being executed.
