...
# STIG_ID: V0072291
# STIG_Version: SV-86915r2
# Rule_ID: RHEL-07-040650
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The system must not allow interfaces to perform Internet Protocol version 4 (IPv4) Internet Control Message Protocol (ICMP) redirects by default.
