...
# STIG_ID: V0072035
# STIG_Version: SV-86659r2
# Rule_ID: RHEL-07-020720
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: All local interactive user initialization files executable search paths must contain only paths that resolve to the users home directory.
