...
# STIG_ID: V0072089
# STIG_Version: SV-86713r1
# Rule_ID: RHEL-07-030330
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The operating system must immediately notify the System Administrator (SA) and Information System Security Officer ISSO (at a minimum) when allocated audit record storage volume reaches 75% of the repository maximum audit record storage capacity.
