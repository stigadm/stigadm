...
# STIG_ID: V0072289
# STIG_Version: SV-86913r2
# Rule_ID: RHEL-07-040640
#
# OS: Red_Hat
# Version: 7
# Architecture: 
#
# Title: The system must prevent Internet Protocol version 4 (IPv4) Internet Control Message Protocol (ICMP) redirect messages from being accepted.
# Description: The system must prevent Internet Protocol version 4 (IPv4) Internet Control Message Protocol (ICMP) redirect messages from being accepted.
