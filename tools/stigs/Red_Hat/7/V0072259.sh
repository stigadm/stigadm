...
# STIG_ID: V0072259
# STIG_Version: SV-86883r2
# Rule_ID: RHEL-07-040430
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The SSH daemon must not permit Generic Security Service Application Program Interface (GSSAPI) authentication unless needed.
