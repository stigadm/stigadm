...
# STIG_ID: V0071917
# STIG_Version: SV-86541r2
# Rule_ID: RHEL-07-010190
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The Red Hat Enterprise Linux operating system must be configured so that when passwords are changed the number of repeating characters of the same character class must not be more than four characters.
