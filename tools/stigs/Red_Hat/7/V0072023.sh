...
# STIG_ID: V0072023
# STIG_Version: SV-86647r1
# Rule_ID: RHEL-07-020660
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: All files and directories contained in local interactive user home directories must be owned by the owner of the home directory.
