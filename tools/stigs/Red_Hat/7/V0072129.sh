...
# STIG_ID: V0072129
# STIG_Version: SV-86753r4
# Rule_ID: RHEL-07-030530
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The Red Hat Enterprise Linux operating system must audit all uses of the open_by_handle_at syscall.
