...
# STIG_ID: V0072253
# STIG_Version: SV-86877r2
# Rule_ID: RHEL-07-040400
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The SSH daemon must be configured to only use Message Authentication Codes (MACs) employing FIPS 140-2 approved cryptographic hash algorithms.
