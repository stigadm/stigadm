...
# STIG_ID: V0072171
# STIG_Version: SV-86795r6
# Rule_ID: RHEL-07-030740
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The Red Hat Enterprise Linux operating system must audit all uses of the mount command and syscall.
