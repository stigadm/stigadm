...
# STIG_ID: V0071963
# STIG_Version: SV-86587r1
# Rule_ID: RHEL-07-010490
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: Systems using Unified Extensible Firmware Interface (UEFI) must require authentication upon booting into single-user and maintenance modes.
