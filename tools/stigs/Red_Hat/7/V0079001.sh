...
# STIG_ID: V0079001
# STIG_Version: SV-93707r2
# Rule_ID: RHEL-07-030821
#
# OS: Red_Hat
# Version: 7
# Architecture: 
...
# Description: The Red Hat Enterprise Linux operating system must audit all uses of the finit_module syscall.
