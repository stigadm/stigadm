...
# STIG_ID: V0038483
# STIG_Version: SV-50283r1
# Rule_ID: RHEL-06-000013
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The system package management tool must cryptographically verify the authenticity of system software packages during installation.
