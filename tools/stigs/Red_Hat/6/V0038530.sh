...
# STIG_ID: V0038530
# STIG_Version: SV-50331r2
# Rule_ID: RHEL-06-000173
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The audit system must be configured to audit all attempts to alter system time through /etc/localtime.
