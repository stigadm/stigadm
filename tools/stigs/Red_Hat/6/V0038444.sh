...
# STIG_ID: V0038444
# STIG_Version: SV-50244r2
# Rule_ID: RHEL-06-000523
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The systems local IPv6 firewall must implement a deny-all, allow-by-exception policy for inbound packets.
