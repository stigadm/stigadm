...
# STIG_ID: V0038550
# STIG_Version: SV-50351r3
# Rule_ID: RHEL-06-000187
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The audit system must be configured to audit all discretionary access control permission modifications using fchmodat.
