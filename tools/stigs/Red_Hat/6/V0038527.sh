...
# STIG_ID: V0038527
# STIG_Version: SV-50328r3
# Rule_ID: RHEL-06-000171
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The audit system must be configured to audit all attempts to alter system time through clock_settime.
