...
# STIG_ID: V0038452
# STIG_Version: SV-50252r2
# Rule_ID: RHEL-06-000518
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The system package management tool must verify permissions on all files and directories associated with packages.
