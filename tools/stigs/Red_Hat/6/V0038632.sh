...
# STIG_ID: V0038632
# STIG_Version: SV-50433r2
# Rule_ID: RHEL-06-000154
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The operating system must produce audit records containing sufficient information to establish what type of events occurred.
