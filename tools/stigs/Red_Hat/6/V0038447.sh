...
# STIG_ID: V0038447
# STIG_Version: SV-50247r3
# Rule_ID: RHEL-06-000519
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The system package management tool must verify contents of all files associated with packages.
