...
# STIG_ID: V0038453
# STIG_Version: SV-50253r2
# Rule_ID: RHEL-06-000517
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The system package management tool must verify group-ownership on all files and directories associated with packages.
