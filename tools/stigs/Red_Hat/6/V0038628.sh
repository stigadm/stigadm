...
# STIG_ID: V0038628
# STIG_Version: SV-50429r2
# Rule_ID: RHEL-06-000145
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The operating system must produce audit records containing sufficient information to establish the identity of any user/subject associated with the event.
