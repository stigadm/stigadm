...
# STIG_ID: V0038522
# STIG_Version: SV-50323r3
# Rule_ID: RHEL-06-000167
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The audit system must be configured to audit all attempts to alter system time through settimeofday.
