...
# STIG_ID: V0038577
# STIG_Version: SV-50378r1
# Rule_ID: RHEL-06-000064
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The system must use a FIPS 140-2 approved cryptographic hashing algorithm for generating account password hashes (libuser.conf).
