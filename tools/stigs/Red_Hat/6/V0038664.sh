...
# STIG_ID: V0038664
# STIG_Version: SV-50465r1
# Rule_ID: RHEL-06-000279
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The system package management tool must verify ownership on all files and directories associated with the audit package.
