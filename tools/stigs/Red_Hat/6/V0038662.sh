...
# STIG_ID: V0038662
# STIG_Version: SV-50463r2
# Rule_ID: RHEL-06-000277
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The operating system must employ cryptographic mechanisms to prevent unauthorized disclosure of data at rest unless otherwise protected by alternative physical measures.
