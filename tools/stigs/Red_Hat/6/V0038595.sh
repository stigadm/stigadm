...
# STIG_ID: V0038595
# STIG_Version: SV-50396r3
# Rule_ID: RHEL-06-000349
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The system must be configured to require the use of a CAC, PIV compliant hardware token, or Alternate Logon Token (ALT) for authentication.
