...
# STIG_ID: V0038688
# STIG_Version: SV-50489r3
# Rule_ID: RHEL-06-000324
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: A login banner must be displayed immediately prior to, or as part of, graphical desktop environment login prompts.
