...
# STIG_ID: V0038576
# STIG_Version: SV-50377r1
# Rule_ID: RHEL-06-000063
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The system must use a FIPS 140-2 approved cryptographic hashing algorithm for generating account password hashes (login.defs).
