...
# STIG_ID: V0038513
# STIG_Version: SV-50314r1
# Rule_ID: RHEL-06-000120
#
# OS: Red_Hat
# Version: 6
# Architecture: 
...
# Description: The systems local IPv4 firewall must implement a deny-all, allow-by-exception policy for inbound packets.
