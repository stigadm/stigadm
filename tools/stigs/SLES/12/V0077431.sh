...
# STIG_ID: V0077431
# STIG_Version: SV-92127r3
# Rule_ID: SLES-12-030010
#
# OS: SLES
# Version: 12
# Architecture: 
#
# Title: The SUSE operating system must display the Standard Mandatory DoD Notice and Consent Banner before granting access via SFTP/FTP.
# Description: SLES
