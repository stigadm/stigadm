...
# STIG_ID: V0077181
# STIG_Version: SV-91877r1
# Rule_ID: SLES-12-010660
#
# OS: SLES
# Version: 12
# Architecture: 
#
# Title: Temporary passwords for SUSE operating system logons must require an immediate change to a permanent password.
# Description: SLES
