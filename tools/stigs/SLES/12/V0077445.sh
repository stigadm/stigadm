...
# STIG_ID: V0077445
# STIG_Version: SV-92141r2
# Rule_ID: SLES-12-030120
#
# OS: SLES
# Version: 12
# Architecture: 
#
# Title: The SUSE operating system must be configured to display the Standard Mandatory DoD Notice and Consent Banner immediately prior to, or as part of, SSH logon prompts.
# Description: SLES
