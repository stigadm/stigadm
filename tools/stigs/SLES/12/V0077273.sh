...
# STIG_ID: V0077273
# STIG_Version: SV-91969r1
# Rule_ID: SLES-12-010880
#
# OS: SLES
# Version: 12
# Architecture: 
#
# Title: SUSE operating system commands and libraries must have the proper permissions to protect from unauthorized access.
# Description: SLES
