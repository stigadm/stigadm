...
# STIG_ID: V0075795
# STIG_Version: SV-90475r3
# Rule_ID: UBTU-16-020850
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the delete_module command must generate an audit record.
# Description: Successful/unsuccessful uses of the delete_module command must generate an audit record.
