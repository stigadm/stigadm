...
# STIG_ID: V0075773
# STIG_Version: SV-90453r3
# Rule_ID: UBTU-16-020740
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful modifications to the faillog file must generate an audit record.
# Description: Successful/unsuccessful modifications to the faillog file must generate an audit record.
