...
# STIG_ID: V0075699
# STIG_Version: SV-90379r3
# Rule_ID: UBTU-16-020400
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the ssh-agent command must generate an audit record.
# Description: Successful/unsuccessful uses of the ssh-agent command must generate an audit record.
