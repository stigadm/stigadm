...
# STIG_ID: V0075781
# STIG_Version: SV-90461r3
# Rule_ID: UBTU-16-020780
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the gpasswd command must generate an audit record.
# Description: Successful/unsuccessful uses of the gpasswd command must generate an audit record.
