...
# STIG_ID: V0075749
# STIG_Version: SV-90429r3
# Rule_ID: UBTU-16-020620
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the creat command must generate an audit record.
# Description: Successful/unsuccessful uses of the creat command must generate an audit record.
