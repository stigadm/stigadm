...
# STIG_ID: V0075437
# STIG_Version: SV-90117r3
# Rule_ID: UBTU-16-010040
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Ubuntu operating system must enable a user session lock until that user re-establishes access using established identification and authentication procedures.
# Description: The Ubuntu operating system must enable a user session lock until that user re-establishes access using established identification and authentication procedures.
