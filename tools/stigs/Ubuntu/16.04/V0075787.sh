...
# STIG_ID: V0075787
# STIG_Version: SV-90467r3
# Rule_ID: UBTU-16-020810
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the crontab command must generate an audit record.
# Description: Successful/unsuccessful uses of the crontab command must generate an audit record.
