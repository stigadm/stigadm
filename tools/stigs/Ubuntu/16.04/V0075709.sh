...
# STIG_ID: V0075709
# STIG_Version: SV-90389r2
# Rule_ID: UBTU-16-020420
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit any usage of the insmod command.
# Description: The audit system must be configured to audit any usage of the insmod command.
