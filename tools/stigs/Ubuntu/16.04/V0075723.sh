...
# STIG_ID: V0075723
# STIG_Version: SV-90403r2
# Rule_ID: UBTU-16-020490
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit any usage of the removexattr system call.
# Description: The audit system must be configured to audit any usage of the removexattr system call.
