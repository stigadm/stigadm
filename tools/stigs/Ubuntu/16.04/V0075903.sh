...
# STIG_ID: V0075903
# STIG_Version: SV-90583r1
# Rule_ID: UBTU-16-030800
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Ubuntu operating system must have the packages required for multifactor authentication to be installed.
# Description: The Ubuntu operating system must have the packages required for multifactor authentication to be installed.
