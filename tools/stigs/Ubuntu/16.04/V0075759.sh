...
# STIG_ID: V0075759
# STIG_Version: SV-90439r3
# Rule_ID: UBTU-16-020670
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the chsh command must generate an audit record.
# Description: Successful/unsuccessful uses of the chsh command must generate an audit record.
