...
# STIG_ID: V0075893
# STIG_Version: SV-90573r2
# Rule_ID: UBTU-16-030700
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Information System Security Officer (ISSO) and System Administrator (SA) (at a minimum) must have mail aliases to be notified of an audit processing failure.
# Description: The Information System Security Officer (ISSO) and System Administrator (SA) (at a minimum) must have mail aliases to be notified of an audit processing failure.
