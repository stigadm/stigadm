...
# STIG_ID: V0075737
# STIG_Version: SV-90417r3
# Rule_ID: UBTU-16-020560
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the chmod command must generate an audit record.
# Description: Successful/unsuccessful uses of the chmod command must generate an audit record.
