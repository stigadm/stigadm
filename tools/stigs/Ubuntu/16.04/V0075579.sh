...
# STIG_ID: V0075579
# STIG_Version: SV-90259r3
# Rule_ID: UBTU-16-010820
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: File systems that are being imported via Network File System (NFS) must be mounted to prevent files with the setuid and setguid bit set from being executed.
