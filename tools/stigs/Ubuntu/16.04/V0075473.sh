...
# STIG_ID: V0075473
# STIG_Version: SV-90153r2
# Rule_ID: UBTU-16-010220
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Passwords for new users must have a 60-day maximum password lifetime restriction.
# Description: Passwords for new users must have a 60-day maximum password lifetime restriction.
