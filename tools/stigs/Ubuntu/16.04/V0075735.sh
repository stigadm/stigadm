...
# STIG_ID: V0075735
# STIG_Version: SV-90415r3
# Rule_ID: UBTU-16-020550
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the lchown command must generate an audit record.
# Description: Successful/unsuccessful uses of the lchown command must generate an audit record.
