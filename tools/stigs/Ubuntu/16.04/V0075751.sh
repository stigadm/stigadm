...
# STIG_ID: V0075751
# STIG_Version: SV-90431r3
# Rule_ID: UBTU-16-020630
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the openat command must generate an audit record.
# Description: Successful/unsuccessful uses of the openat command must generate an audit record.
