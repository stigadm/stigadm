...
# STIG_ID: V0075575
# STIG_Version: SV-90255r2
# Rule_ID: UBTU-16-010800
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: File systems that contain user home directories must be mounted to prevent files with the setuid and setguid bit set from being executed.
