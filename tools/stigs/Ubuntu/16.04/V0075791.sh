...
# STIG_ID: V0075791
# STIG_Version: SV-90471r3
# Rule_ID: UBTU-16-020830
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the init_module command must generate an audit record.
# Description: Successful/unsuccessful uses of the init_module command must generate an audit record.
