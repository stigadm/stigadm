...
# STIG_ID: V0075883
# STIG_Version: SV-90563r2
# Rule_ID: UBTU-16-030580
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Ubuntu operating system must not allow interfaces to perform Internet Protocol version 4 (IPv4) Internet Control Message Protocol (ICMP) redirects by default.
