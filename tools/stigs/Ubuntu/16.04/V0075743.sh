...
# STIG_ID: V0075743
# STIG_Version: SV-90423r3
# Rule_ID: UBTU-16-020590
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the open command must generate an audit record.
# Description: Successful/unsuccessful uses of the open command must generate an audit record.
