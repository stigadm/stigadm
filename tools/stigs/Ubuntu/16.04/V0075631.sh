...
# STIG_ID: V0075631
# STIG_Version: SV-90311r1
# Rule_ID: UBTU-16-020070
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must take appropriate action when audit storage is full.
# Description: The audit system must take appropriate action when audit storage is full.
