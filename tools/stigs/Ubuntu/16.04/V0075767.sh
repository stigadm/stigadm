...
# STIG_ID: V0075767
# STIG_Version: SV-90447r3
# Rule_ID: UBTU-16-020710
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the setfacl command must generate an audit record.
# Description: Successful/unsuccessful uses of the setfacl command must generate an audit record.
