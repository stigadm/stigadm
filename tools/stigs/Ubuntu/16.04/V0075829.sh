...
# STIG_ID: V0075829
# STIG_Version: SV-90509r2
# Rule_ID: UBTU-16-030230
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Ubuntu operating system must implement DoD-approved encryption to protect the confidentiality of SSH connections.
# Description: The Ubuntu operating system must implement DoD-approved encryption to protect the confidentiality of SSH connections.
