...
# STIG_ID: V0075745
# STIG_Version: SV-90425r3
# Rule_ID: UBTU-16-020600
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the truncate command must generate an audit record.
# Description: Successful/unsuccessful uses of the truncate command must generate an audit record.
