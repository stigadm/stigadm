...
# STIG_ID: V0075509
# STIG_Version: SV-90189r1
# Rule_ID: UBTU-16-010400
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: All persistent disk partitions must implement cryptographic mechanisms to prevent unauthorized disclosure or modification of all information that requires at rest protection.
# Description: All persistent disk partitions must implement cryptographic mechanisms to prevent unauthorized disclosure or modification of all information that requires at rest protection.
