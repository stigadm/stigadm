...
# STIG_ID: V0075713
# STIG_Version: SV-90393r2
# Rule_ID: UBTU-16-020440
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit any usage of the modprobe command.
# Description: The audit system must be configured to audit any usage of the modprobe command.
