...
# STIG_ID: V0075727
# STIG_Version: SV-90407r3
# Rule_ID: UBTU-16-020510
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit any usage of the fremovexattr system call.
# Description: The audit system must be configured to audit any usage of the fremovexattr system call.
