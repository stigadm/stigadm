...
# STIG_ID: V0075659
# STIG_Version: SV-90339r2
# Rule_ID: UBTU-16-020210
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit event multiplexor must be configured to off-load audit logs onto a different system or storage media from the system being audited.
# Description: The audit event multiplexor must be configured to off-load audit logs onto a different system or storage media from the system being audited.
