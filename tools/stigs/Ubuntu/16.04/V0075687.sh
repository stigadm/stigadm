...
# STIG_ID: V0075687
# STIG_Version: SV-90367r3
# Rule_ID: UBTU-16-020340
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
...
# Description: The Ubuntu operating system must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/security/opasswd.
