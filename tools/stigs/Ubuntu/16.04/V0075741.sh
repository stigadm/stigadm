...
# STIG_ID: V0075741
# STIG_Version: SV-90421r3
# Rule_ID: UBTU-16-020580
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the fchmodat command must generate an audit record.
# Description: Successful/unsuccessful uses of the fchmodat command must generate an audit record.
