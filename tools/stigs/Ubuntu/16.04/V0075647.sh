...
# STIG_ID: V0075647
# STIG_Version: SV-90327r1
# Rule_ID: UBTU-16-020150
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Ubuntu operating system must allow only the Information System Security Manager (ISSM) (or individuals or roles appointed by the ISSM) to select which auditable events are to be audited.
