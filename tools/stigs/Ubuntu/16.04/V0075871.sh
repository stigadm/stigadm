...
# STIG_ID: V0075871
# STIG_Version: SV-90551r2
# Rule_ID: UBTU-16-030520
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: For Ubuntu operating systems using Domain Name Servers (DNS) resolution, at least two name servers must be configured.
