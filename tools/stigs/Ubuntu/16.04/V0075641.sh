...
# STIG_ID: V0075641
# STIG_Version: SV-90321r2
# Rule_ID: UBTU-16-020120
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Audit logs must be group-owned by root to prevent unauthorized read access.
# Description: Audit logs must be group-owned by root to prevent unauthorized read access.
