...
# STIG_ID: V0075769
# STIG_Version: SV-90449r3
# Rule_ID: UBTU-16-020720
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the chacl command must generate an audit record.
# Description: Successful/unsuccessful uses of the chacl command must generate an audit record.
