...
# STIG_ID: V0075697
# STIG_Version: SV-90377r3
# Rule_ID: UBTU-16-020390
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the umount command must generate an audit record.
# Description: Successful/unsuccessful uses of the umount command must generate an audit record.
