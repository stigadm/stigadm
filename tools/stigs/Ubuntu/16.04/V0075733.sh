...
# STIG_ID: V0075733
# STIG_Version: SV-90413r3
# Rule_ID: UBTU-16-020540
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the fchownat command must generate an audit record.
# Description: Successful/unsuccessful uses of the fchownat command must generate an audit record.
