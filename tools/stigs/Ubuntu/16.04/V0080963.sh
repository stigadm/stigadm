...
# STIG_ID: V0080963
# STIG_Version: SV-95675r1
# Rule_ID: UBTU-16-020170
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit log files in the Ubuntu operating system must have mode 0640 or less permissive.
# Description: The audit log files in the Ubuntu operating system must have mode 0640 or less permissive.
