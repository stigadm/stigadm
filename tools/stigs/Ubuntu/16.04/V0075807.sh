...
# STIG_ID: V0075807
# STIG_Version: SV-90487r2
# Rule_ID: UBTU-16-030050
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: An application firewall must employ a deny-all, allow-by-exception policy for allowing connections to other systems.
# Description: An application firewall must employ a deny-all, allow-by-exception policy for allowing connections to other systems.
