...
# STIG_ID: V0075731
# STIG_Version: SV-90411r3
# Rule_ID: UBTU-16-020530
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the fchown command must generate an audit record.
# Description: Successful/unsuccessful uses of the fchown command must generate an audit record.
