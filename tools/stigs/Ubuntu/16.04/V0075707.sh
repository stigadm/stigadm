...
# STIG_ID: V0075707
# STIG_Version: SV-90387r3
# Rule_ID: UBTU-16-020410
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the ssh-keysign command must generate an audit record.
# Description: Successful/unsuccessful uses of the ssh-keysign command must generate an audit record.
