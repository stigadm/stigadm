...
# STIG_ID: V0075793
# STIG_Version: SV-90473r3
# Rule_ID: UBTU-16-020840
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the finit_module command must generate an audit record.
# Description: Successful/unsuccessful uses of the finit_module command must generate an audit record.
