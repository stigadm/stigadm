...
# STIG_ID: V0075515
# STIG_Version: SV-90195r3
# Rule_ID: UBTU-16-010500
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: A file integrity tool must be installed to verify correct operation of all security functions in the Ubuntu operating system.
# Description: A file integrity tool must be installed to verify correct operation of all security functions in the Ubuntu operating system.
