...
# STIG_ID: V0075637
# STIG_Version: SV-90317r2
# Rule_ID: UBTU-16-020100
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Audit log directories must have a mode of 0750 or less permissive to prevent unauthorized read access.
# Description: Audit log directories must have a mode of 0750 or less permissive to prevent unauthorized read access.
