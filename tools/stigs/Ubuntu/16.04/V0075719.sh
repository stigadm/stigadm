...
# STIG_ID: V0075719
# STIG_Version: SV-90399r2
# Rule_ID: UBTU-16-020470
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit any usage of the lsetxattr system call.
# Description: The audit system must be configured to audit any usage of the lsetxattr system call.
