...
# STIG_ID: V0075577
# STIG_Version: SV-90257r3
# Rule_ID: UBTU-16-010810
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: File systems that are used with removable media must be mounted to prevent files with the setuid and setguid bit set from being executed.
