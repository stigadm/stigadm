...
# STIG_ID: V0075391
# STIG_Version: SV-90071r4
# Rule_ID: UBTU-16-010010
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Ubuntu vendor packaged system security patches and updates must be installed and up to date.
# Description: Ubuntu vendor packaged system security patches and updates must be installed and up to date.
