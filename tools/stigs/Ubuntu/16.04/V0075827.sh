...
# STIG_ID: V0075827
# STIG_Version: SV-90507r2
# Rule_ID: UBTU-16-030220
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Ubuntu operating system must not permit direct logons to the root account using remote access via SSH.
