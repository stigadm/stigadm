...
# STIG_ID: V0075775
# STIG_Version: SV-90455r3
# Rule_ID: UBTU-16-020750
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful modifications to the lastlog file must generate an audit record.
# Description: Successful/unsuccessful modifications to the lastlog file must generate an audit record.
