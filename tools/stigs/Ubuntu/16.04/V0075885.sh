...
# STIG_ID: V0075885
# STIG_Version: SV-90565r2
# Rule_ID: UBTU-16-030590
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Ubuntu operating system must not send Internet Protocol version 4 (IPv4) Internet Control Message Protocol (ICMP) redirects.
