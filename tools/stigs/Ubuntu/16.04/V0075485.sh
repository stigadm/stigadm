...
# STIG_ID: V0075485
# STIG_Version: SV-90165r3
# Rule_ID: UBTU-16-010280
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Account identifiers (individuals, groups, roles, and devices) must disabled after 35 days of inactivity.
# Description: Account identifiers (individuals, groups, roles, and devices) must disabled after 35 days of inactivity.
