...
# STIG_ID: V0075529
# STIG_Version: SV-90209r1
# Rule_ID: UBTU-16-010570
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Advance package Tool (APT) must remove all software components after updated versions have been installed.
