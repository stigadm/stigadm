...
# STIG_ID: V0075783
# STIG_Version: SV-90463r3
# Rule_ID: UBTU-16-020790
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the chage command must generate an audit record.
# Description: Successful/unsuccessful uses of the chage command must generate an audit record.
