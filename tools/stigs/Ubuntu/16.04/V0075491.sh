...
# STIG_ID: V0075491
# STIG_Version: SV-90171r1
# Rule_ID: UBTU-16-010310
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Temporary user accounts must be provisioned with an expiration time of 72 hours or less.
# Description: Temporary user accounts must be provisioned with an expiration time of 72 hours or less.
