...
# STIG_ID: V0075755
# STIG_Version: SV-90435r3
# Rule_ID: UBTU-16-020650
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the sudo command must generate an audit record.
# Description: Successful/unsuccessful uses of the sudo command must generate an audit record.
