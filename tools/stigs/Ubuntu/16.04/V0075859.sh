...
# STIG_ID: V0075859
# STIG_Version: SV-90539r2
# Rule_ID: UBTU-16-030430
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
...
# Description: The audit system must take appropriate action when the network cannot be used to off-load audit records.
