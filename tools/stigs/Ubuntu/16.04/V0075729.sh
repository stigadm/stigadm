...
# STIG_ID: V0075729
# STIG_Version: SV-90409r3
# Rule_ID: UBTU-16-020520
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the chown command must generate an audit record.
# Description: Successful/unsuccessful uses of the chown command must generate an audit record.
