...
# STIG_ID: V0075531
# STIG_Version: SV-90211r2
# Rule_ID: UBTU-16-010580
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Automatic mounting of Universal Serial Bus (USB) mass storage driver must be disabled.
# Description: Automatic mounting of Universal Serial Bus (USB) mass storage driver must be disabled.
