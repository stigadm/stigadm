...
# STIG_ID: V0075695
# STIG_Version: SV-90375r3
# Rule_ID: UBTU-16-020380
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the mount command must generate an audit record.
# Description: Successful/unsuccessful uses of the mount command must generate an audit record.
