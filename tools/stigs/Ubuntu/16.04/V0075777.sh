...
# STIG_ID: V0075777
# STIG_Version: SV-90457r3
# Rule_ID: UBTU-16-020760
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the passwd command must generate an audit record.
# Description: Successful/unsuccessful uses of the passwd command must generate an audit record.
