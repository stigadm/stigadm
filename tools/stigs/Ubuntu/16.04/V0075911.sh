...
# STIG_ID: V0075911
# STIG_Version: SV-90591r1
# Rule_ID: UBTU-16-030840
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
...
# Description: The Ubuntu operating system must implement smart card logins for multifactor authentication for access to accounts.
