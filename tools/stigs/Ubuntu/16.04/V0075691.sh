...
# STIG_ID: V0075691
# STIG_Version: SV-90371r3
# Rule_ID: UBTU-16-020360
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the su command must generate an audit record.
# Description: Successful/unsuccessful uses of the su command must generate an audit record.
