...
# STIG_ID: V0075879
# STIG_Version: SV-90559r3
# Rule_ID: UBTU-16-030560
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Ubuntu operating system must prevent Internet Protocol version 4 (IPv4) Internet Control Message Protocol (ICMP) redirect messages from being accepted.
