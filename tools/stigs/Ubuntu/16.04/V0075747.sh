...
# STIG_ID: V0075747
# STIG_Version: SV-90427r3
# Rule_ID: UBTU-16-020610
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the ftruncate command must generate an audit record.
# Description: Successful/unsuccessful uses of the ftruncate command must generate an audit record.
