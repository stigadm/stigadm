...
# STIG_ID: V0075627
# STIG_Version: SV-90307r1
# Rule_ID: UBTU-16-020050
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The System Administrator (SA) and Information System Security Officer (ISSO) (at a minimum) must be alerted when the audit storage volume is full.
# Description: The System Administrator (SA) and Information System Security Officer (ISSO) (at a minimum) must be alerted when the audit storage volume is full.
