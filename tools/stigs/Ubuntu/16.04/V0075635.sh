...
# STIG_ID: V0075635
# STIG_Version: SV-90315r2
# Rule_ID: UBTU-16-020090
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Audit logs must have a mode of 0600 or less permissive to prevent unauthorized read access.
# Description: Audit logs must have a mode of 0600 or less permissive to prevent unauthorized read access.
