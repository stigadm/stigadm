...
# STIG_ID: V0075451
# STIG_Version: SV-90131r2
# Rule_ID: UBTU-16-010110
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
...
# Description: The Ubuntu operating system must enforce password complexity by requiring that at least one lower-case character be used.
