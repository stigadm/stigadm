...
# STIG_ID: V0075761
# STIG_Version: SV-90441r4
# Rule_ID: UBTU-16-020680
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the newgrp command must generate an audit record.
# Description: Successful/unsuccessful uses of the newgrp command must generate an audit record.
