...
# STIG_ID: V0080957
# STIG_Version: SV-95669r1
# Rule_ID: UBTU-16-010631
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The x86 Ctrl-Alt-Delete key sequence in the Ubuntu operating system must be disabled if GNOME is installed.
