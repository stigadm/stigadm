...
# STIG_ID: V0075725
# STIG_Version: SV-90405r2
# Rule_ID: UBTU-16-020500
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit any usage of the lremovexattr system call.
# Description: The audit system must be configured to audit any usage of the lremovexattr system call.
