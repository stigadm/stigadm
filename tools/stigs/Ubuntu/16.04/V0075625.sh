...
# STIG_ID: V0075625
# STIG_Version: SV-90305r2
# Rule_ID: UBTU-16-020040
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The System Administrator (SA) and Information System Security Officer (ISSO) (at a minimum) must be alerted of an audit processing failure event.
# Description: The System Administrator (SA) and Information System Security Officer (ISSO) (at a minimum) must be alerted of an audit processing failure event.
