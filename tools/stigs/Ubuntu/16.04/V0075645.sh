...
# STIG_ID: V0075645
# STIG_Version: SV-90325r2
# Rule_ID: UBTU-16-020140
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Audit log directory must be group-owned by root to prevent unauthorized read access.
# Description: Audit log directory must be group-owned by root to prevent unauthorized read access.
