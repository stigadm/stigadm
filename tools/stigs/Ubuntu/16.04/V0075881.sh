...
# STIG_ID: V0075881
# STIG_Version: SV-90561r2
# Rule_ID: UBTU-16-030570
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Ubuntu operating system must ignore Internet Protocol version 4 (IPv4) Internet Control Message Protocol (ICMP) redirect messages.
