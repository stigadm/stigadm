...
# STIG_ID: V0075689
# STIG_Version: SV-90369r2
# Rule_ID: UBTU-16-020350
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit the execution of privileged functions and prevent all software from executing at higher privilege levels than users executing the software.
# Description: The audit system must be configured to audit the execution of privileged functions and prevent all software from executing at higher privilege levels than users executing the software.
