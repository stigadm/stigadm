...
# STIG_ID: V0075753
# STIG_Version: SV-90433r3
# Rule_ID: UBTU-16-020640
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the open_by_handle_at command must generate an audit record.
# Description: Successful/unsuccessful uses of the open_by_handle_at command must generate an audit record.
