...
# STIG_ID: V0075643
# STIG_Version: SV-90323r2
# Rule_ID: UBTU-16-020130
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Audit log directory must be owned by root to prevent unauthorized read access.
# Description: Audit log directory must be owned by root to prevent unauthorized read access.
