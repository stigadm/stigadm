...
# STIG_ID: V0075511
# STIG_Version: SV-90191r1
# Rule_ID: UBTU-16-010410
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: All public directories must be owned by root to prevent unauthorized and unintended information transferred via shared system resources.
# Description: All public directories must be owned by root to prevent unauthorized and unintended information transferred via shared system resources.
