...
# STIG_ID: V0075507
# STIG_Version: SV-90187r2
# Rule_ID: UBTU-16-010390
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
...
# Description: Ubuntu operating systems booted with United Extensible Firmware Interface (UEFI) implemented must require authentication upon booting into single-user mode and maintenance.
