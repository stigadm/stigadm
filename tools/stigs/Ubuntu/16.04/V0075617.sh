...
# STIG_ID: V0075617
# STIG_Version: SV-90297r1
# Rule_ID: UBTU-16-020000
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Audit records must contain information to establish what type of events occurred, the source of events, where events occurred, and the outcome of events.
# Description: Audit records must contain information to establish what type of events occurred, the source of events, where events occurred, and the outcome of events.
