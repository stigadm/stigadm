...
# STIG_ID: V0075523
# STIG_Version: SV-90203r3
# Rule_ID: UBTU-16-010540
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The file integrity tool must notify the system administrator when changes to the baseline configuration or anomalies in the operation of any security functions are discovered.
# Description: The file integrity tool must notify the system administrator when changes to the baseline configuration or anomalies in the operation of any security functions are discovered.
