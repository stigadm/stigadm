...
# STIG_ID: V0075715
# STIG_Version: SV-90395r2
# Rule_ID: UBTU-16-020450
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit any usage of the kmod command.
# Description: The audit system must be configured to audit any usage of the kmod command.
