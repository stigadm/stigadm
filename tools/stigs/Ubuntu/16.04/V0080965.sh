...
# STIG_ID: V0080965
# STIG_Version: SV-95677r1
# Rule_ID: UBTU-16-020220
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit records must be off-loaded onto a different system or storage media from the system being audited.
# Description: The audit records must be off-loaded onto a different system or storage media from the system being audited.
