...
# STIG_ID: V0075551
# STIG_Version: SV-90231r1
# Rule_ID: UBTU-16-010680
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: User accounts with temporary passwords, must require an immediate change to a permanent password after login.
# Description: User accounts with temporary passwords, must require an immediate change to a permanent password after login.
