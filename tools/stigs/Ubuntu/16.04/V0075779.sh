...
# STIG_ID: V0075779
# STIG_Version: SV-90459r3
# Rule_ID: UBTU-16-020770
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the unix_update command must generate an audit record.
# Description: Successful/unsuccessful uses of the unix_update command must generate an audit record.
