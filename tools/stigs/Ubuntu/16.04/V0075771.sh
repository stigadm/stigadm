...
# STIG_ID: V0075771
# STIG_Version: SV-90451r3
# Rule_ID: UBTU-16-020730
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful modifications to the tallylog file must generate an audit record.
# Description: Successful/unsuccessful modifications to the tallylog file must generate an audit record.
