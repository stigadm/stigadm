...
# STIG_ID: V0075785
# STIG_Version: SV-90465r3
# Rule_ID: UBTU-16-020800
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the usermod command must generate an audit record.
# Description: Successful/unsuccessful uses of the usermod command must generate an audit record.
