...
# STIG_ID: V0080969
# STIG_Version: SV-95681r1
# Rule_ID: UBTU-16-020690
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the chcon command must generate an audit record.
# Description: Successful/unsuccessful uses of the chcon command must generate an audit record.
