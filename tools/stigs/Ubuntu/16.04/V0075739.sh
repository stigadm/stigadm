...
# STIG_ID: V0075739
# STIG_Version: SV-90419r3
# Rule_ID: UBTU-16-020570
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the fchmod command must generate an audit record.
# Description: Successful/unsuccessful uses of the fchmod command must generate an audit record.
