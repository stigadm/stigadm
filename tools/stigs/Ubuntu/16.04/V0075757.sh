...
# STIG_ID: V0075757
# STIG_Version: SV-90437r3
# Rule_ID: UBTU-16-020660
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the sudoedit command must generate an audit record.
# Description: Successful/unsuccessful uses of the sudoedit command must generate an audit record.
