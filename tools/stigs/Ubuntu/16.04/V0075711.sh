...
# STIG_ID: V0075711
# STIG_Version: SV-90391r2
# Rule_ID: UBTU-16-020430
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit any usage of the rmmod command.
# Description: The audit system must be configured to audit any usage of the rmmod command.
