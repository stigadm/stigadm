...
# STIG_ID: V0075483
# STIG_Version: SV-90163r1
# Rule_ID: UBTU-16-010270
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The passwd command must be configured to prevent the use of dictionary words as passwords.
# Description: The passwd command must be configured to prevent the use of dictionary words as passwords.
