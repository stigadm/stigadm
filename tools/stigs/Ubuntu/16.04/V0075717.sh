...
# STIG_ID: V0075717
# STIG_Version: SV-90397r2
# Rule_ID: UBTU-16-020460
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit any usage of the setxattr system call.
# Description: The audit system must be configured to audit any usage of the setxattr system call.
