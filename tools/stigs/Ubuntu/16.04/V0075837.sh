...
# STIG_ID: V0075837
# STIG_Version: SV-90517r2
# Rule_ID: UBTU-16-030270
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The Ubuntu operating system for all network connections associated with SSH traffic must immediately terminate at the end of the session or after 10 minutes of inactivity.
# Description: The Ubuntu operating system for all network connections associated with SSH traffic must immediately terminate at the end of the session or after 10 minutes of inactivity.
