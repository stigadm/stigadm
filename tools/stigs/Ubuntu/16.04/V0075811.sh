...
# STIG_ID: V0075811
# STIG_Version: SV-90491r4
# Rule_ID: UBTU-16-030070
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: A sticky bit must be set on all public directories to prevent unauthorized and unintended information transferred via shared system resources.
# Description: A sticky bit must be set on all public directories to prevent unauthorized and unintended information transferred via shared system resources.
