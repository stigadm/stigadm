...
# STIG_ID: V0075441
# STIG_Version: SV-90121r2
# Rule_ID: UBTU-16-010060
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
...
# Description: Ubuntu operating system sessions must be automatically logged out after 15 minutes of inactivity.
