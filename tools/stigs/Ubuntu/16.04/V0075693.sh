...
# STIG_ID: V0075693
# STIG_Version: SV-90373r3
# Rule_ID: UBTU-16-020370
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the chfn command must generate an audit record.
# Description: Successful/unsuccessful uses of the chfn command must generate an audit record.
