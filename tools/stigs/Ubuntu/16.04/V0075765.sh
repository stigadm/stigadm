...
# STIG_ID: V0075765
# STIG_Version: SV-90445r3
# Rule_ID: UBTU-16-020700
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Successful/unsuccessful uses of the apparmor_parser command must generate an audit record.
# Description: Successful/unsuccessful uses of the apparmor_parser command must generate an audit record.
