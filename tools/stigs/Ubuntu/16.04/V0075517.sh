...
# STIG_ID: V0075517
# STIG_Version: SV-90197r2
# Rule_ID: UBTU-16-010510
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The file integrity tool must perform verification of the correct operation of security functions
# Description:  upon system start-up and/or restart; upon command by a user with privileged access; and/or every 30 days.
