...
# STIG_ID: V0075721
# STIG_Version: SV-90401r2
# Rule_ID: UBTU-16-020480
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The audit system must be configured to audit any usage of the fsetxattr system call.
# Description: The audit system must be configured to audit any usage of the fsetxattr system call.
