...
# STIG_ID: V0075465
# STIG_Version: SV-90145r2
# Rule_ID: UBTU-16-010180
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: The pam_unix.so module must use a FIPS 140-2 approved cryptographic hashing algorithm for system authentication.
# Description: The pam_unix.so module must use a FIPS 140-2 approved cryptographic hashing algorithm for system authentication.
