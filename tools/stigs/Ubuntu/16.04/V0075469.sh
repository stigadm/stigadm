...
# STIG_ID: V0075469
# STIG_Version: SV-90149r1
# Rule_ID: UBTU-16-010200
#
# OS: Ubuntu
# Version: 16.04
# Architecture: LTS
#
# Title: Emergency administrator accounts must never be automatically removed or disabled.
# Description: Emergency administrator accounts must never be automatically removed or disabled.
