...
# STIG_ID: V0029496
# STIG_Version: SV-38700r1
# Rule_ID: GEN000000-AIX0210
#
# OS: AIX
# Version: 6.1
# Architecture:
...
# Description: The system must provide protection from Internet Control Message Protocol (ICMP) attacks on TCP connections.
